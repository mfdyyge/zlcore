 ...
 *
 */
public class webmagic_dfcf_MX implements PageProcessor{
...
*/
           ...
           // System.out.println("picUrl:"+picUrl);//输出对象
    ...
    public static void main(String[] args)
    {
        ...
        Spider.create(new webmagic_dfcf_MX()).addUrl("http://data.eastmoney.com/dxf/default.html").thread(5).run();
