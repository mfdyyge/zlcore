...
public class ResultSet6
{
  public static void main(String[] args) throws SQLException
  {
    ...
    ResultSet rset = stmt.executeQuery ("select EMPLOYEE_ID, " +
                                               "FIRST_NAME, " +
                                               "LAST_NAME, SALARY " +
                                        "from EMPLOYEES");
    ...
    System.out.println ("List EMPLOYEE_ID, FIRST_NAME, LAST_NAME and SALARY" +
    ...
    System.out.println ("List EMPLOYEE_ID, FIRST_NAME, LAST_NAME " +
                        "and SALARY again: ");
    int salary = 0;
    while (rset.next())
    {
  ...
  public static void doSomeChanges (Connection conn)
    throws SQLException
  {
    System.out.println ("Update the employee salary outside " +
                        "the result set\n");
