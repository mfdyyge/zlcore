...
if "%1" == "orcl" set JDBC_URL=jdbc:oracle:orcl:@ &goto next
if "%1" == "ocitns" set JDBC_URL="jdbc:oracle:orcl:@(DESCRIPTION=(ADDRESS=(PROTOCOL=tcp)(HOST=%ORACLE_HOST%)(PORT=%ORACLE_PORT%))(CONNECT_DATA=(SERVICE_NAME=%ORACLE_SERVICE_NAME%)))" &goto next
