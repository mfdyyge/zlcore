...
import com.zl.core.jdbc.apche.dbutils.pojo.Zy;
...
/**
 * Created by 钢背猪☣ on 2017-9-14 0014.
 *
...
public class query_test
{
    ...
    public void find() throws SQLException {
        ...
        Object params[] = {2};
        Zy zy = (Zy) qr.query(sql, params, new BeanHandler(Zy.class));
        System.out.println(zy.getRemark());
    }
    ...
    public void getAll() throws SQLException {
        ...
        List list = (List) qr.query(sql, new BeanListHandler(Zy.class));
