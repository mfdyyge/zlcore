package apche.dbutils.test.query.db.sql;
...
public class SQLQueryBuilderTest {
    ...
    public void testDistinct() {
        ...
        System.out.println("sql.buildQuery() = " + sql.buildQuery());
    }
...
//
        ...
        //select VC2,to_char(TS,'YYYY-MM-DD HH24:MI:SS.FF')  from TEST08;

        SQLQueryBuilder sql_test08 = new SQLQueryBuilder();
        sql_test08.table("test08","test");
        sql_test08.field("test.ts","time");
    ...
    public void testOrderBy() {
        ...
        System.out.println("sql1.buildQuery() = " + sql1.buildQuery());
